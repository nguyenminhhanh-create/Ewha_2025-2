...
# --- Constants ---
# Use absolute path relative to this script location to avoid CWD issues
script_dir = os.path.dirname(os.path.abspath(__file__))
DATA_FILE = os.path.join(script_dir, "daily_trending_videos.xlsb.csv")
    ...
    if os.path.exists(DATA_FILE):
        try:
            ...
            if 'country' in df.columns:
                ...
                st.error("Dataset missing 'country' column. Cannot filter for Korea.")
                return None
        ...
        st.error(f"File {DATA_FILE} not found. Please place it in the application directory.")
        return None
...
with st.sidebar:
    ...
    **YouTube Trending Predictor (Korea)**
    ...
    This app analyzes historical trending video statistics from `daily_trending_videos.xlsb.csv` and predicts future performance for the first half of 2026.
